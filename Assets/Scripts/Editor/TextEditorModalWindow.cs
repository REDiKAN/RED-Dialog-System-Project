...
public class TextEditorModalWindow : VisualElement
{
    ...
    public TextEditorModalWindow(string initialText, string nodeGuid, Action<string> onTextChanged)
    {
        ...
        var btnConvertBack = new Button(ConvertToMarkdown) { text = "← MD" };
        btnConvertBack.style.backgroundColor = new StyleColor(new Color(0.4f, 0.2f, 0.6f));
        btnConvertBack.style.color = Color.white;
        btnConvertBack.style.marginLeft = 4;
        ...
        formatToolbar.Add(btnConvertBack);
        Add(formatToolbar);

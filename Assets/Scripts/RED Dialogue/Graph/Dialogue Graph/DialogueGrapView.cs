...
public class DialogueGraphView : GraphView
{
    ...
    public void CreateNode(FlowNode node, string nodeName, Vector2 mousePosition)
    {
        if (node is DialogueNode dialogueNode)
            CreateDialogueNode(nodeName, mousePosition);
        else 
            CreateUtilitNode(nodeName, mousePosition);
    }
    ...
    /// </summary>
    private void CreateDialogueNode(string nodeName, Vector2 position)
    {
    ...
    private void CreateUtilitNode(string nodeName, Vector2 position)
    {
        var dialogueNode = new DialogueNode
        {
            title = nodeName,
